...
def generate_airfoil_points(num_points):
    ...
    # Use np.zeros instead of np.empty + manual zeroing because modern OS and
    # NumPy allocate zeroed memory pages (e.g. via mmap with MAP_ANONYMOUS),
    # which avoids the page faults and CPU cache overhead of explicit zero-filling.
